...
<p align="center">
    ...
    <img src="https://img.shields.io/github/size/bebasid/bebasid/releases/hosts.svg?label=ukuran" alt="Ukuran rilis"></br>
    <a href="#"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2Fbebasid%2Fbebasid_fGHyh&count_bg=%234572CD&title_bg=%23555555&icon_color=%23E7E7E7&title=penonton%3A+%28hari%20ini%2Ftotal%29&edge_flat=false"/></a></br>
...
- [BebasID](#bebasid)
  ...
  - [Metode Lain](#metode-lain)
    + [BebasID Source (Kode Sumber)](#bebasid-source)
    + [BebasDNS / BebasID DNS](#bebasdns--bebasid-dns)
    + [Pengguna Lainnya](#pengguna-lainnya)
...
Jika anda membutuhkan kode sumber BebasID (GUI), silahkan menuju ke repo [BebasID-source](https://github.com/bebasid/bebasid-src) untuk menggunakannya.

### <code>BebasDNS / BebasID DNS:</code>
Jika hosts ini tidak cocok untuk anda, dan menggunakan versi DNS atau DoH/DoT, silahkan menuju ke repo [BebasDNS](https://github.com/bebasid/bebasdns) untuk menggunakannya.

### <code>Pengguna Lainnya:</code>
...
Bantu proyek ini agar VPS [BebasDNS / BebasID DNS](https://github.com/bebasid/bebasdns/blob/main/README.md#bebasdns---bebasid-dns) dan proyek [BebasID](#bebasid) ini tetap berjalan dengan cara berdonasi.

<div>
<details>
 <summary>:coffee: Traktir kami kopi: [v]</summary>
